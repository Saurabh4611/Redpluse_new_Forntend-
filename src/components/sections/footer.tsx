...
const contactInfo = [
    ...
    },
    {
        icon: <SuEmail />,
        label: "Make a Quote",
        value: "Redpluse@gmail.com",
        link: "mailto:Redpluse@gmail.com",
    },
    {
        icon: <SuLocation />,
        label: "Location",
...
const quickLinks = [
    { text: "Redpluse About", link: "/about" },
...
const recentPosts = [
    {
        image: "/img/news/news-02.png",
        date: "20 Feb, 2025",
        title: "2021 Blood Cancer Awareness Month: A Message from the CEO",
        link: "/news-details",
    },
    {
        image: "/img/news/news-01.png",
        date: "15 Dec, 2025",
        title: "Blood Donation Awareness Camp 2021",
        link: "/news-details",
    },
];
                        ...
                        >
                            <div className="single-footer-widget">
                                ...
                                <div className="footer-content">
                                    <p>
                                       Redpluse is a non-profit organization dedicated to saving lives through blood donation. We connect donors with those in need, fostering a community of compassion and support. Join us in making a difference and giving the gift of life.
                                    </p>
                ...
                <div className="container">
                    <div className="footer-wrapper d-flex align-items-center justify-content-between">
                        <p className="wow slideLeft color-2" data-delay=".3">
                            © All Copyright 2025 by <Link to="index"></Link> {" "}
                             & Distributed by <Link to="https://Redpluseorg.com" target="_blank">Redpluse Organisation</Link>
                        </p>
